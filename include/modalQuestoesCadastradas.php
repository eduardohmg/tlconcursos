...
<div class="modal-header">
	...
	<h4 class="modal-title" id="myModalLabel2">Visualizar Questão</h4>
</div>
<div class="modal-body">
	<div class="generic-background"style="padding-top: 20px; box-shadow:none;">
		<strong>Questão 1</strong>
		<hr style="margin-top: 15px;">
		<ul class="list-unstyled">
			<li><strong>ID da questão:</strong> <?php echo $id_questao;?></li>
