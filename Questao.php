<?php
	...
	$sql_inventario = mysql_query("SELECT * FROM inventario WHERE id_usuario='".$_SESSION['id_usuario']."' AND id_questao='".$id_questao."'");
?>
								...
								<div class="float-static">
									<div class="pull-right">
										<?php
											...
											{
										?>
										<a id="linkComprar" href='javascript:MostrarModal(<?php echo $id_questao; ?>)'>
										...
										{
										?>
											<div class="greenp"><span class='glyphicon glyphicon-ok' aria-hidden='true' ></span> Adquirida</div>
										<?php } ?>
									</div>	
								</div>
